...
#define RS485_DIR_PIN_NUM_PORT	PORTD
#define RS485_DIR_PIN_NUM		PORTD4

#define RS485_TX_MODE	do{sbit(RS485_DIR_PIN_NUM_PORT,RS485_DIR_PIN_NUM);}while(0)
#define RS485_RX_MODE	do{cbit(RS485_DIR_PIN_NUM_PORT,RS485_DIR_PIN_NUM);}while(0)
